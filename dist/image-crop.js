...
export var ImageCrop = function (_a) {
    var file = _a.file, aspect = _a.aspect, proportions = _a.proportions, sizeConfig = _a.sizeConfig, step = _a.step, confirmImage = _a.confirmImage;
    ...
    if ((step === 'end' || step === 'confirm') && imageUrl) {
        return _jsx(Canvas, { aspect: aspect, canvasRef: canvasRef, confirmImage: confirmImage, cropConfig: cropConfig, imageUrl: imageUrl, originalImageSize: originalImageSize, proportions: proportions, renderSize: renderSize, sizeConfig: sizeConfig, step: step });
    }
